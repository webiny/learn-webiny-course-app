...
export const chapterMetadata: Record<string, ChapterMetadata> = {
  ...
  "headless-cms": {
    ...
    description:
      "Learn how to manage content, create content models, and use the Headless CMS API.",
    icon: "wysiwyg",
  },
  "website-builder": {
    number: 6,
    ...
    description:
      "Learn how to create and manage websites using Webiny Website Builder.",
    icon: "table_chart",
  },
  "multi-tenancy": {
    number: 7,
    ...
    description:
      "Learn how multi-tenancy works in Webiny and how to set it up.",
    icon: "table_chart",
  },
