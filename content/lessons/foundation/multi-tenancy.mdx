...
<Image src="/images/lessons/foundation/multi-tenancy.png" alt="Webiny Multi Tenancy" />
...
Webiny is built with multi-tenancy in mind, allowing you to manage multiple projects from a single instance. In this lesson, we will explore the concept of multi-tenancy in Webiny and how it can benefit your content management needs.
...
- **Cost Efficiency**: By sharing resources, multi-tenancy reduces infrastructure costs, making it more affordable to manage multiple projects.
...
A user created under the root tenant can access manage the content of child tenants, while users created under a child tenant can only access and manage their own tenant's data. The root-level users can be also restricted so they can only access specific child tenants.
