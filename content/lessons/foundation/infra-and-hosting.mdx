...
The built-in template also ensure many additional best practices, such as setting up automated backups, multi-AZ deployments for high availability, auto-scaling to handle traffic spikes, VPC deployment, and much more. In addition to the infrastructure templates, Webiny also comes with built-in CI/CD template for GitHub Actions to automate the deployment process, making it easy to deploy updates and new features to your Webiny instance.
