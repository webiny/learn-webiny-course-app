...
```typescript title="extensions/MyApiKeyAfterUpdate.ts"
...
<Callout type="hint" title="Finding Components">
  Use the React DevTools "Select Element" tool to click on any UI element and immediately see which
  React component renders it. This is invaluable when working with unfamiliar code.
</Callout>
