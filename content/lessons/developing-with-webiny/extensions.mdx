...
<CodeBlock language="typescript" filename="extensions/MyGraphQLSchema.ts" code={`import { GraphQLSchemaFactory } from "webiny/api/graphql";
...
<CodeBlock language="tsx" filename="extensions/AdminBranding/AdminLogo.tsx" code={`import React from "react";
...
<CodeBlock language="tsx" filename="webiny.config.tsx" code={`<Infra.Env.Is env="prod">
