...
<Callout type="hint" title="Extensions Lesson">
  We'll explore webiny.config.tsx in detail in the Extensions lesson. For now, just know this is
  where all configuration lives.
</Callout>
...
<Callout type="info" title="Learn More in Extensions Lesson">
  The Extensions lesson covers how to create and register extensions in detail. For now, just know
  that the extensions/ folder is your workspace for custom code.
</Callout>
