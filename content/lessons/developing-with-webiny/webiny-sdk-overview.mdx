...
| -------------------- | ----------------------------------------------------- |
| `sdk.cms`            | List, get, create, update, publish, unpublish entries |
| `sdk.fileManager`    | Upload and manage files                               |
| `sdk.languages`      | Retrieve configured languages                         |
| `sdk.tenantManager`  | Create and manage tenants                             |
| `sdk.tasks`          | Trigger and manage background tasks                   |
...
The examples below use `sdk.cms` for illustration, but the same concepts apply across all SDK modules — `sdk.fileManager`, `sdk.languages`, `sdk.tenantManager`, `sdk.tasks`, and any others.
...
Expand **Dev Tools** in the Admin sidebar and click **SDK Playground**:

<Image
  src="/learn/images/developing-with-webiny/sdk-playground-menu.png"
  alt="Webiny Admin sidebar showing the Dev Tools section with SDK Playground option highlighted"
  caption="Access the SDK Playground from Dev Tools in the Admin sidebar"
/>
...
<Image
  src="/learn/images/developing-with-webiny/sdk-playground-editor.png"
