...
<Image src="/images/lessons/getting-started/deployment-environments.svg" alt="Webiny Deployment Environments"/>
...
<ChapterOverview
    items={[
        ...
        { icon: "draw_abstract", text: "What are deployment modes." },
    ]}
/>
...
<Quiz
    ...
    correctAnswer={3}
    explanation="Correct! Short-lived environments are perfect for testing and developing new features as they can be easily created and destroyed without affecting your main environments."
    hint="There are only two types of environments: Long lived and short-lived, can you guess which one is temporary and used for testing new features."
/>
