...
<Image
  src="/images/headless-cms/contact-submission-sidebar.png"
...
Notice how we use the Result pattern here instead of try-catch:

1. Call `sdk.cms.createEntry()` and get a `result` object
2. Check if successful with `result.isOk()`
3. If successful: return the data via `result.value`
4. If failed: return the error via `result.error.message`
...
<Image
  src="/images/headless-cms/contact-form-success.png"
...
<Image
  src="/images/headless-cms/contact-submission-in-admin.png"
