...
<Image
  src="/learn/images/headless-cms/custom-data-list.png"
  alt="Webiny Admin showing Contact Submissions list with custom Email and Email Type columns positioned right after the Name column"
  caption="The Contact Submission list now displays Email and Email Type columns right after the Name column"
/>
