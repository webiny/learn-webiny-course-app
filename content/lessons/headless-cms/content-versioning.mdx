...
<Callout type="hint" title="Multiple Drafts">
  While you can only have one published revision at a time, you can create and
  maintain multiple draft revisions simultaneously. This gives you flexibility
  to experiment with different content variations.
</Callout>
