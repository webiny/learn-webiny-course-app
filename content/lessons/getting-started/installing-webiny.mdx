...
At this point you should have a folder called `learn-webiny-course` which contains your Webiny project. In the next lesson, we will cover how to deploy Webiny to AWS and access the admin panel for the first time.
